...
<body>
    ...
    <div class="wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="appointment" class="sidebar-dropdown list-unstyled collapse"
                        ...
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link" hx-get="/appointmentlist" hx-target="body" hx-swap="innerHTML">
                                <i class="ri-notification-2-fill"></i>Appointment List
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link" hx-get="/appointmentrecord" hx-target="body" hx-swap="innerHTML">
        ...
        <div class="main p-3">
            ...
            <p>Content for Appointment Record goes here.</p>
        </div>
    </div>  
</body>
<script>
