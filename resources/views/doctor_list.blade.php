                    ...
                    <div class="col-md-8">
                        <div class="row mt-2 justify-content-between">
                            ...
                            <div class="col-md-4 d-flex justify-content-end">
                                <a href="" class="btn btn-primary"><i class="fa-solid fa-plus me-1"></i>Add Doctor</a>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-4">
                                <div class="card p-2">
                                    <span>Name: Dr.HAROLD</span>
                                    <br>
                                    <p>Specialization:</p>
                                    <div class="row align-content-end">
                                        <div class="col d-flex justify-content-end">
                                            <button class="btn btn-sm btn-secondary rounded-pill me-1"><i class="fa-regular fa-pen-to-square"></i></button>
                                            <button class="btn btn-sm btn-success rounded-pill me-1"><i class="fa-solid fa-calendar"></i></button>
                                            <button class="btn btn-danger btn-sm rounded-pill me-1"><i class="fa-solid fa-trash"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card p-3">
                        <div class="row">
                            <div class="d-flex align-items-center">
                                ...
                                <i class="fa-solid fa-greater-than p-2"></i>
                            </div>
